...
const Modal = () => {
  ...
  return (
    ...
    className={`top-0 left-0 right-0 bottom-0 ${isModal ? `fixed` : `hidden`} modal flex justify-center items-center`}>
        <div onClick={(e) => e.stopPropagation()} className='bg-[#fff] rounded-[10px] w-[350px] md:w-[500px] m-auto relative md:p-5 p-4'>
        ...
        <XCircle size={16}/> <span className='pl-1'>Cancel</span> </button>
    </div>
             </div>
